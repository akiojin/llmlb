...
- 未完了SPECの残タスクを棚卸しし、依存関係に基づく進行順を整理する
- ✅ SPEC-e03a404c: Phase 3.3 の型定義（T006/T007）を実装し tasks.md を更新する
- ✅ SPEC-e03a404c: Phase 3.4 のRouter側実装（T009-T011）に着手し tasks.md を更新する
- ✅ SPEC-e03a404c: Phase 3.5 Node側（T012/T013）を実装し tasks.md を更新する
  - ✅ vision_processor の追加（画像デコード/前処理）
  - ✅ openai_endpoints の messages.content配列対応（text + image_url）
