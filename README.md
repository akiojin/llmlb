...
# (LLMLB_INTERNAL_API_TOKEN is optional; auto-generated if missing)
```
...
| `LLMLB_INTERNAL_API_TOKEN` | (optional; auto-generated if missing) | Internal token for /api, /dashboard, /ws |
...
| `LLMLB_INTERNAL_API_TOKEN` | (optional; auto-generated if missing) | Internal token for /api, /dashboard, /ws | `INTERNAL_API_TOKEN` |
