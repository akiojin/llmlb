...
```bash
# 現在の設定を確認
gh api repos/akiojin/llm-router/branches/develop/protection/required_status_checks

# 正しいチェック名で更新
gh api \
  --method PUT \
  repos/akiojin/llm-router/branches/develop/protection/required_status_checks/contexts \
