...
日本語の音声入力を試したい場合は、英語専用の `ggml-tiny.en.bin` ではなく多言語モデルを使ってください:

```bash
WHISPER_MODEL_NAME=ggml-tiny.bin ASR_LANGUAGE=ja ASR_WAV_PATH="/path/to/your_voice.m4a" ./poc/audio-io-demo/run_audio_io_poc.sh
```
