...
> 更新: 2026-01-26 (マルチモーダル実装完了・SPEC整合更新)
>
...
| SPEC ID | 機能名 | ステータス | 優先度 |
|---------|--------|-----------|--------|
| SPEC-32637000 | モデルcapabilitiesルーティング検証 | ✅ 済 | P2 |
...
| SPEC-5fc9fe92 | Playground Chatマルチモーダル対応 | ✅ 済 | P2 |
| SPEC-ae3f974e | 画像生成モデル対応 | ✅ 済 | P1 |
| SPEC-e03a404c | 画像認識モデル対応 | 🚧 部分 | P1 |
...
| SPEC-a7e6d40a | CLI インターフェース整備 (moved to xLLM repo) | ✅ 済 | - |
