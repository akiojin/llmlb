...
ルーター側で推論リクエストの待機キューを管理し、各ノードは単発リクエストのみを処理する。
...
- **対象コンポーネント**:
  - Router (Rust): キュー制御、選択ロジック、APIレスポンス
...
- **シンプルさ**: ルーターの待機カウンタと通知を活用し、専用キュー実装は最小限
