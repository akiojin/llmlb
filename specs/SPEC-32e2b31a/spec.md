...
15. **プラットフォームインストーラー**: macOS `.pkg` と Windows `.msi` で Router/Node のインストーラーを提供する
    - Router: `llm-router-<platform>.pkg` / `llm-router-<platform>.msi`
    - Node: `llm-node-<platform>.pkg` / `llm-node-<platform>.msi`
