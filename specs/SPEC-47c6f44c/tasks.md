...
**機能ID**: `SPEC-47c6f44c` | **入力**: `/llmlb/specs/SPEC-47c6f44c/`の設計ドキュメント
...
- [x] **T002** [P] 既存`ci.yml`をバックアップ
  - **ファイル**: `/llmlb/.github/workflows/ci.yml`
...
- [x] **T003** [P] `test-quality-checks.yml`を作成（品質チェックワークフローのテスト）
  - **ファイル**: `/llmlb/.github/workflows/test-quality-checks.yml`
...
- [x] **T004** [P] `test-auto-merge.yml`を作成（自動マージワークフローのテスト）
  - **ファイル**: `/llmlb/.github/workflows/test-auto-merge.yml`
...
- [x] **T006** `quality-checks.yml`を作成（品質チェック統合ワークフロー）
  - **ファイル**: `/llmlb/.github/workflows/quality-checks.yml`
  - **参照**: `contracts/quality-checks.contract.yml`
  - **内容**:
...
- [x] **T007** `auto-merge.yml`を作成（自動マージワークフロー）
  - **ファイル**: `/llmlb/.github/workflows/auto-merge.yml`
...
- [x] **T013** [P] `finish-feature.sh`のPRボディを更新
  - **ファイル**: `/llmlb/.specify/scripts/bash/finish-feature.sh`
  - **更新内容**:
