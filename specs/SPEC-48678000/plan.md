...
1. 共有パス（ルーター側キャッシュ）を直接参照
2. 共有パスがアクセス不可ならルーターHTTP API経由でダウンロード
3. ルーターにもなければエラー

従来のauto_repair（破損検出・修復）機能は削除。Hugging Face直接ダウンロードは禁止。
