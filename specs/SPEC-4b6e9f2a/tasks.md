...
- [ ] Unit: モデル名パーサ（プレフィックス検出、タイポ互換、デフォルトローカル）
- [ ] Unit: 設定バリデーション（キー未設定時のエラー）
...
- [ ] モデル名パーサとクラウドルート判定の共通化
- [ ] OpenAI クラウドクライアント実装（非ストリーミング/ストリーミング）
- [ ] Google クラウドクライアント実装（非ストリーミング/ストリーミング）
- [ ] Anthropic クラウドクライアント実装（非ストリーミング/ストリーミング）
