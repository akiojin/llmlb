...
- [x] `[P]` T-13: エラー応答時のトークンカウントテスト
- [x] `[P]` T-14: オフラインノードの統計保持テスト
...
- [x] I-6: エラー応答時のトークンカウント実装
  - 依存: C-3, T-13
- [x] I-7: オフラインノードの統計保持確認
  - 依存: C-7, T-14
...
- [x] `[P]` P-3: API仕様書更新
- [x] `[P]` P-4: DEVELOPMENT.md更新（トークン統計機能説明追加）

### 品質保証

- [x] P-5: 統合テスト実行・全パス確認
- [x] P-6: E2Eテスト実行・全パス確認
- [x] P-7: markdownlint / cargo fmt / cargo clippy 実行
