...
**ステータス**: 🚧 **部分実装** (Phase 1完了: 3/24タスク = 12.5%)
...
- [ ] **T007** [P] `coordinator/tests/contract/metrics_test.rs` に POST /api/agents/:id/metrics のcontract test
  - リクエスト: AgentMetrics
