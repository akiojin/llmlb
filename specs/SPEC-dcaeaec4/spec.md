...
> **⚠️ この要件は SPEC-93536000 により廃止されました。**
>
> 各ノードはGPUバックエンドに基づいて独自の実行可能モデル一覧（`executable_models`）を持ち、
> ルーターはオンラインノードの実行可能モデルを集約します。
> 詳細は [SPEC-93536000](../SPEC-93536000/spec.md) を参照してください。
