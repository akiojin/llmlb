...
> 最終更新: 2026-01-14 (SPEC-66555000追加)
>
> 総SPEC数: **48** | 廃止: 6 | plan.md欠損: 0 | 依存関係完全化済み
...
> 48件中、明示的な依存関係があるSPEC: 32件 | 基盤SPEC（依存なし）: 10件 | 廃止: 6件
...
| `SPEC-66555000` | ルーター主導エンドポイント登録システム | **未着手** |
